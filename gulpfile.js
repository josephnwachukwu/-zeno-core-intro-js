...
/**
 * 2.5 Clone the /css folder into /.tmp. If an npm link inside /src has been made,
 *    then it's likely that a node_modules folder exists. Ignore this folder
 *    when copying to /.tmp.
 */
gulp.task('copy:css', function () {
  ...
  return gulp.src([`${tmpFolder}/styles.css`])
    .pipe(gulp.dest(`${buildFolder}/theme`));
});
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    ...
    .pipe(rename('ng2-intro-js.umd.js'))
    .pipe(gulp.dest(distFolder));
});
